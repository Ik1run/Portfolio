...
const cardData: BentoCardProps[] = [
  {
    color: '#060010',
    title: 'Punisho',
    description: 'Student sanctions tracking app',
  ...
  {
    color: '#060010',
    title: 'ASP.NET WebApp',
    description: 'Private app made for a care zoo',
    label: 'Internship'
  },
  {
    color: '#060010',
    title: '.NET MAUI APP',
    description: 'Private app made for volunteers to track events and tasks',
    label: 'Internship'
  },
  {
    color: '#060010',
